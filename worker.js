...
function fallbackReply(messages) {
  ...
  if (latest.includes('price') || latest.includes('pricing') || latest.includes('plan') || latest.includes('cost')) {
    return 'Lone Star ITS offers three support tiers — Basic Support, Standard Support, and Premium Support — plus a standalone Web Design & Management plan. Pricing is customized to your team size and needs: use the Contact page, select your plan of interest, and our team will follow up with a quote.';
  }

  if (latest.includes('web') && (latest.includes('design') || latest.includes('site') || latest.includes('management'))) {
    return 'Lone Star ITS offers standalone Web Design & Management, with ongoing monthly management available after launch. Premium Support clients get access to Web Design & Management. Use the Contact page to request a custom quote.';
  }
